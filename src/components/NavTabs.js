    ...
    <ul className="nav nav-tabs d-flex justify-content-end align-items-end">
      <li className="nav-item">
        <a
          ...
          className= {currentPage === 'Home' ? 'nav-link active active1 noTextDec' : 'nav-link noTextDec'}
          id="noTextDec"
          style ={styles.active}
        >
          About
      ...
      <li className="nav-item">
        <a
          ...
          className={currentPage === 'About' ? 'nav-link active noTextDec' : 'nav-link noTextDec'}
          id="noTextDec"
          style ={styles.active}
        >
          Portfolio
